"""Media upload utilities using the configured media API."""
...
async def get_media_client() -> AsyncGenerator[httpx.AsyncClient]:
    """Provide an async HTTP client configured for the media API."""
...
async def upload_file(file: BytesIO, file_name: str | None = None) -> str:
    """Upload a file to the media API and return its public URL."""
